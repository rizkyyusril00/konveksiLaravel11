<x-layout>
    <div class="w-full md:w-[75%] lg:w-[80%] pt-4 px-3 md:pl-12 md:pr-4 lg:px-4 h-screen bg-primary flex flex-col gap-4">
        ...
        {{-- header --}}
        <x-header title="User" addRoute="AddUser" />
        ...
        {{-- action mobile --}}
        <form method="GET" action="/user" class="md:hidden flex items-center gap-2">
            <div class="relative">
                <input type="text" name="search" value="" placeholder="Cari nama..."
            ...
            <a href="/user" class="flex items-center justify-center bg-secondary w-[30px] h-[30px] rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg"
                    class="hover:scale-[1.03] transition-all duration-300 ease-in-out" width="18" height="18"
                    fill="#ffffff" viewBox="0 0 256 256">
                    <path
