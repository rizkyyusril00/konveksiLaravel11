<x-layout>
    <div
        ...
        @endif
        <form action="{{ route('AddPembelian') }}" method="POST"
            ...
            <h1 class="text-[24px] text-start text-secondary font-semibold">Tambah Pembelian</h1>
            @csrf
            {{-- invoice --}}
            <div class="flex flex-col gap-2 w-full">
                ...
                <input autocomplete="on" id="invoice" type="text" name="invoice"
                    class="text-secondary text-[16px] p-4 rounded-md" placeholder="Invoice...">
                @error('invoice')
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <input autocomplete="on" id="name" type="text" name="name"
                    class="text-secondary text-[16px] p-4 rounded-md" placeholder="Nama Barang...">
                @error('name')
                    <span class="text-red-400">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <input id="tanggal_pembelian" type="date" name="tanggal_pembelian"
                    value="{{ old('tanggal_pembelian') }}" class="text-secondary text-[16px] p-4 rounded-md"
            ...
            <div class="flex flex-col w-full gap-2">
                ...
                <input id="tanggal_tempo" type="date" name="tanggal_tempo" value="{{ old('tanggal_tempo') }}"
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <input id="hutang" type="number" name="hutang"
                    class="text-secondary text-[16px] p-4 rounded-md" placeholder="Hutang...">
                @error('hutang')
                    <span class="text-red-400">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <div class="flex items-center gap-1">
                    <input id="tipe1" type="radio" name="status" checked="checked"
                        class="radio radio-secondary radio-sm" value="Lunas">
