    ...
    <div class="block md:flex relative h-screen">
        ...
        <div
            ...
            <div class="flex flex-col flex-grow">
                ...
                {{-- item --}}
                <a href="/item"
                    class="flex items-center gap-2 p-2 hover:bg-accent transition-all duration-300 ease-in-out hover:pl-3 rounded-md {{ request()->is('item') ? 'pl-3 bg-accent text-secondary' : 'pl-0 bg-primary' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#000000"
                        viewBox="0 0 256 256">
                        <path
        ...
        @if (
            !request()->is('add*') &&
                !request()->is('updateOrder*') &&
                !request()->is('updateSupplier*') &&
                !request()->is('updateCustomer*') &&
                !request()->is('updateKaryawan*') &&
                !request()->is('updateUser*'))
            <div
