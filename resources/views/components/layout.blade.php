    ...
    <div class="flex">
        ...
        <div class="w-[20%] pt-[100px] px-4 border-r border-accent h-screen flex flex-col gap-6 fixed">
            ...
            <div class="flex flex-col flex-grow">
                ...
                {{-- supplier --}}
                <a href="/supplier"
                    class="flex items-center gap-2 p-2 hover:bg-slate-200 transition-all duration-300 ease-in-out hover:pl-3 {{ request()->is('supplier') ? 'pl-3 bg-slate-200 text-secondary' : 'pl-0 bg-primary' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="#000000"
                        viewBox="0 0 256 256">
                        <path
