<x-layout>
    <div
        ...
        <form action="{{ route('EditItem') }}" method="POST"
            ...
            <h1 class="text-[24px] text-start text-secondary font-semibold">Edit Item</h1>
            @csrf
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <div class="flex items-center gap-1">
                    <input id="tipe1" type="radio" name="tipe" class="radio radio-secondary radio-sm"
                        value="Bahan Utama" {{ $item->tipe == 'Bahan Utama' ? 'checked' : '' }}>
                ...
                <div class="flex items-center gap-1">
                    <input id="tipe2" type="radio" name="tipe" class="radio radio-secondary radio-sm"
                        value="Bahan Tambahan" {{ $item->tipe == 'Bahan Tambahan' ? 'checked' : '' }}>
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <input autocomplete="on" id="name" type="text" name="name" value="{{ $item->name }}"
            ...
            <div class="flex flex-col gap-2 w-full">
                ...
                <input id="sisa" type="text" name="sisa" value="{{ $item->sisa }}"
                    class="text-secondary text-[16px] p-4 rounded-md" placeholder="Sisa...">
                @error('sisa')
                    <span class="text-red-400">{{ $message }}</span>
                @enderror
            </div>
