<x-layout>
    <div class="w-full md:w-[75%] lg:w-[80%] pt-4 px-3 md:pl-12 md:pr-4 lg:px-4 h-screen bg-primary flex flex-col gap-4">
        ...
        {{-- header --}}
        <x-header title="Item" addRoute="AddItem" />

        {{-- action  --}}
        <div class="hidden md:flex items-center justify-between gap-2">
            <form method="GET" action="/item" class="flex items-center gap-2">
                <div class="relative">
                ...
                <a href="/item" class="flex items-center justify-center bg-secondary w-8 h-8 rounded-full">
            ...
            {{-- btn add --}}
            <a href="/add/item" class="btn h-10 min-h-10 btn-secondary w-fit flex items-center gap-2 group">
                ...
                <span class="text-[12px] text-primary">Tambah Item</span>
            </a>
        </div>
        ...
        <div class="md:hidden flex flex-col gap-2">
            <form method="GET" action="/item" class="flex items-center gap-2">
                ...
                <a href="/item" class="flex items-center justify-center bg-secondary w-[30px] h-[30px] rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="hover:scale-[1.03] transition-all duration-300 ease-in-out" width="18" height="18"
                        fill="#ffffff" viewBox="0 0 256 256">
                        <path
                                            ...
                                            <template x-if="open">
                                                <div x-transition:enter="transition transform ease-out duration-300"
                                                    ...
                                                    <div class="bg-white p-6 rounded-lg shadow-lg w-fit">
                                                        <h3 class="text-lg font-bold">Hapus Item Ini?</h3>
                                                        <p class="py-4">Apakah anda yakin akan hapus item dengan
                                                            nama
