<x-layout>
    <div class="flex flex-col items-center justify-center w-full h-full gap-4 pt-[100px] px-4">
        ...
        @endif
        <form action="{{ route('AddPakaian') }}" method="POST" class="w-full flex flex-col gap-4 px-40">
            @csrf
            <div class="flex flex-col gap-1 w-full">
                <label for="">Jenis Pakaian</label>
                <input type="text" name="name" class="p-4 rounded-md" placeholder="Tambah Jenis Pakaian...">
                @error('name')
